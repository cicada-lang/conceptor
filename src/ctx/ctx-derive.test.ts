...
console.log(
  Ctx.objs_derive_attrs(bodies_of_water, new Objs.Objs(["canal", "channel"]))
)
console.log(
  Ctx.objs_closure(bodies_of_water, new Objs.Objs(["canal", "channel"]))
)
...
console.log(
  Ctx.attrs_derive_objs(planets, new Attrs.Attrs(["distance-from-sun.far"]))
)
console.log(
  Ctx.attrs_derive_objs(planets, new Attrs.Attrs(["distance-from-sun.near"]))
)
